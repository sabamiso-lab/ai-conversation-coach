 ...
 * @param {Object} props
 * @param {Object} props.situation - シチュエーション情報
 * @param {string} [props.className='sidebar-panel']
 */
export default function ChatSidebar({ situation, className = 'sidebar-panel' }) {
