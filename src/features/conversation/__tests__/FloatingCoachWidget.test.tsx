...
import FloatingCoachWidget, { type FloatingCoachWidgetProps } from '../FloatingCoachWidget';
import type { Situation, CoachMessage, ChatMessage } from '../../../types';

describe('FloatingCoachWidget component', () => {
  const mockSituation: Partial<Situation> = {
    id: 'cafe-order',
    title: 'Cafe Order',
    titleJa: 'カフェでの注文'
  };

  const defaultProps: FloatingCoachWidgetProps = {
