 ...
 * @param {Object} props
 * @param {boolean} props.isPlaying - 再生中フラグ
 * @param {boolean} props.isLooping - リピート中フラグ
 * @param {number} props.playbackSpeed - 現在の再生速度
 * @param {Function} props.onPlayToggle - 再生/停止トグル
 * @param {Function} props.onLoopToggle - リピートトグル
 * @param {Function} props.onSpeedChange - 再生速度変更ハンドラ
 * @param {string} [props.className='player-controls-wrap']
 */
